      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <h2 className="text-lg sm:text-2xl font-bold flex flex-wrap items-center gap-2">
          <span className="relative inline-block">
            Firefighting
            <span className="absolute left-0 -bottom-1 w-3/4 h-[3px] bg-green-500"></span>
          </span>
          <span>System</span>
        ...
        {products.map((product) => (
          ...
          >
            ...
            <Link
              ...
              className="block mt-3 text-center text-xs sm:text-sm py-2 rounded-md text-white bg-gradient-to-r from-emerald-400 to-indigo-500 hover:opacity-90 transition"
            >
              View Details
            </Link>
          </div>
